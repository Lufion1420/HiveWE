...
4. Prefer `semantic_search` for symbol/call-path questions before wide `grep` loops or explore subagents.
5. Use `task(subagent_type: "explore")` when ownership is unknown across multiple subsystems.
