...
1. Re-run the exact failing case (`NCOW_Arena.w3x`, "Rename imported files to random names" on, everything else default) with both fixes and confirm: the export succeeds, the loading screen and custom UI render correctly in-game.
